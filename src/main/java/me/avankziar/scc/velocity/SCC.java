package main.java.me.avankziar.scc.velocity;
...
import main.java.me.avankziar.scc.velocity.assistance.BackgroundTask;
import main.java.me.avankziar.scc.velocity.assistance.Utility;
import main.java.me.avankziar.scc.velocity.commands.ClickChatCommandExecutor;
import main.java.me.avankziar.scc.velocity.commands.MessageCommandExecutor;
import main.java.me.avankziar.scc.velocity.commands.RCommandExecutor;
import main.java.me.avankziar.scc.velocity.commands.ReCommandExecutor;
import main.java.me.avankziar.scc.velocity.commands.SccCommandExecutor;
import main.java.me.avankziar.scc.velocity.commands.SccEditorCommandExecutor;
import main.java.me.avankziar.scc.velocity.commands.WCommandExecutor;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGBook;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGBroadcast;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGBroadcastServer;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGChannel;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGChannelGui;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGDebug;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGIgnore;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGIgnoreList;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGItem;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGItem_Rename;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGItem_Replacers;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGMute;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGOption;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGOption_Channel;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGOption_Join;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGOption_Spy;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGPerformance;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGUnmute;
import main.java.me.avankziar.scc.velocity.commands.scc.ARGUpdatePlayer;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_Ban;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_ChangePassword;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_Channels;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_ChatColor;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_Create;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_Delete;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_Info;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_Inherit;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_Invite;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_Join;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_Kick;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_Leave;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_NameColor;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_Player;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_Rename;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_Symbol;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_Unban;
import main.java.me.avankziar.scc.velocity.commands.scc.pc.ARGPermanentChannel_Vice;
import main.java.me.avankziar.scc.velocity.commands.scc.tc.ARGTemporaryChannel;
import main.java.me.avankziar.scc.velocity.commands.scc.tc.ARGTemporaryChannel_Ban;
import main.java.me.avankziar.scc.velocity.commands.scc.tc.ARGTemporaryChannel_ChangePassword;
import main.java.me.avankziar.scc.velocity.commands.scc.tc.ARGTemporaryChannel_Create;
import main.java.me.avankziar.scc.velocity.commands.scc.tc.ARGTemporaryChannel_Info;
import main.java.me.avankziar.scc.velocity.commands.scc.tc.ARGTemporaryChannel_Invite;
import main.java.me.avankziar.scc.velocity.commands.scc.tc.ARGTemporaryChannel_Join;
import main.java.me.avankziar.scc.velocity.commands.scc.tc.ARGTemporaryChannel_Kick;
import main.java.me.avankziar.scc.velocity.commands.scc.tc.ARGTemporaryChannel_Leave;
import main.java.me.avankziar.scc.velocity.commands.scc.tc.ARGTemporaryChannel_Unban;
...
import main.java.me.avankziar.scc.velocity.database.MysqlSetup;
import main.java.me.avankziar.scc.velocity.handler.ChatHandler;
import main.java.me.avankziar.scc.velocity.ifh.ChannelProvider;
import main.java.me.avankziar.scc.velocity.ifh.ChatEditorProvider;
import main.java.me.avankziar.scc.velocity.ifh.ChatProvider;
import main.java.me.avankziar.scc.velocity.ifh.ChatTitleProvider;
import main.java.me.avankziar.scc.velocity.listener.ChatListener;
import main.java.me.avankziar.scc.velocity.listener.JoinLeaveListener;
import main.java.me.avankziar.scc.velocity.listener.ServerListener;
import main.java.me.avankziar.scc.velocity.metric.Metrics;
...
public class SCC
{
    ...
    @Inject
    public SCC(ProxyServer server, Logger logger, @DataDirectory Path dataDirectory, Metrics.Factory metricsFactory) 
    {
    	SCC.plugin = this;
        this.server = server;
        this.logger = logger;
    ...
    private void setupCommandTree()
	{
		...
		ArgumentConstructor debug = new ArgumentConstructor(baseCommandI+"_debug", 0, 1, 999, false, null);
		...
		CommandMeta sccmeta = cm.metaBuilder(scc.getName()).plugin(plugin).build();
		
		CommandConstructor clch = new CommandConstructor(baseCommandII, true);
		CommandMeta clchmeta = cm.metaBuilder(clch.getName()).plugin(plugin).build();
		
		CommandConstructor scceditor = new CommandConstructor(baseCommandIII, true);
		CommandMeta scceditormeta = cm.metaBuilder(scceditor.getName()).plugin(plugin).build();
		
		CommandConstructor msg = new CommandConstructor(baseCommandIV, false);
		CommandMeta msgmeta = cm.metaBuilder(msg.getName()).plugin(plugin).build();
		...
		CommandMeta remeta = cm.metaBuilder(re.getName()).plugin(plugin).build();
		
		CommandConstructor r = new CommandConstructor(baseCommandVI, false);
		CommandMeta rmeta = cm.metaBuilder(r.getName()).plugin(plugin).build();
		
		CommandConstructor w = new CommandConstructor(baseCommandVII, true);
		CommandMeta wmeta = cm.metaBuilder(w.getName()).plugin(plugin).build();
		
		cm.register(sccmeta, new SccCommandExecutor(plugin, scc));
		cm.register(clchmeta, new ClickChatCommandExecutor(plugin, clch));
		cm.register(scceditormeta, new SccEditorCommandExecutor(plugin, scceditor));
		cm.register(msgmeta, new MessageCommandExecutor(plugin, msg));
		cm.register(remeta, new ReCommandExecutor(plugin, re));
		cm.register(rmeta, new RCommandExecutor(plugin, r));
		cm.register(wmeta, new WCommandExecutor(plugin, w));
	...
	private void setupIFHConsumer()
    {
		...
		}).delay(15L*1000, TimeUnit.MILLISECONDS).repeat(25L, TimeUnit.MILLISECONDS).schedule();
    ...
    {
    	server.getEventManager().register(plugin, new ServerListener(plugin));
    	ChannelRegistrar cr = server.getChannelRegistrar();
    	cr.register(MinecraftChannelIdentifier.from(StaticValues.SCC_TOPROXY));
        cr.register(MinecraftChannelIdentifier.from(StaticValues.SCC_TOSPIGOT));
    }
