...
import main.java.me.avankziar.scc.general.database.MysqlBaseSetup;
import main.java.me.avankziar.scc.general.database.ServerType;
import main.java.me.avankziar.scc.spigot.SCC;

public class MysqlSetup  extends MysqlBaseSetup
{	
	public MysqlSetup(SCC plugin, boolean adm, String path)
	{
