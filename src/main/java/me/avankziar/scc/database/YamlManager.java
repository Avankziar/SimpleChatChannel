...
public class YamlManager
{
	...
	public void initCommands()
	{
		...
		commandsInput("clch", "scc", "scc.cmd.clch", 
		...
		argumentInput(path+"pc_ban", "ban", basePermission,
				...
				"&c/scc permanentchannel <channelname> <playername> &f| Bans a player from a permanent channel.");
		...
		argumentInput(path+"pc_changepassword", "changepassword", basePermission,
				...
				"&c/scc permanentchannel <Channelname> <Passwort> &f| Ändert das Passwort von einem permanenten Channel.",
				"&c/scc permanentchannel <channelname> <password> &f| Changes the password of a permanent channel.");
	...
	public void initChannels() //INFO:Channels
	{
		...
		channelsKeys.put("private.ChatFormat"
				, new Language(new ISO639_2B[] {ISO639_2B.GER}, new Object[] {
				"&7[%time%] %playername_with_prefixhighcolorcode% &r&e>> %other_playername_with_prefixhighcolorcode% &r&7: %message%"}));
