...
public class MysqlInterface 
{
	...
	public boolean updateDataI(ProxiedPlayer player, Object object, String wherecolumn) 
	{
	...
	public boolean updateDataII(ProxiedPlayer player, Object object, String wherecolumn) 
	{
		if (!hasAccount(player)) 
		{
			createAccount(player);
