package main.java.me.avankziar.simplechatchannels.bungee.database.tables;
...
{
	default boolean existIV(SimpleChatChannels plugin, String whereColumn, Object... object) 
	{
	...
	default boolean deleteDataIV(SimpleChatChannels plugin, String whereColumn, Object... whereObject)
	{
		PreparedStatement preparedStatement = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
		try 
	...
	default int lastIDIV(SimpleChatChannels plugin)
	{
		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
	...
	default int countWhereIDIV(SimpleChatChannels plugin, String whereColumn, Object... whereObject)
	{
		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
